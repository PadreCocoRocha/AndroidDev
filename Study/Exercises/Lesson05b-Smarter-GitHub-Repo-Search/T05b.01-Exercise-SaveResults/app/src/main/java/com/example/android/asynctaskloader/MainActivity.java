...
public class MainActivity extends AppCompatActivity {
    ...
    static final String KEY_LAST_SEARCHED_URL = "lsu_key";

    // COMPLETE (2) Create a static final key to store the search's raw JSON
    static final String KEY_LAST_RAW_JSON_RESULT = "lrjr_key";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null){
            if (savedInstanceState.containsKey(KEY_LAST_RAW_JSON_RESULT))
                mSearchResultsTextView.setText(
                        savedInstanceState.getString(KEY_LAST_RAW_JSON_RESULT));
            if (savedInstanceState.containsKey(KEY_LAST_SEARCHED_URL))
                mSearchBoxEditText.setText(savedInstanceState.getString(KEY_LAST_SEARCHED_URL));
        }
    }
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        outState.putString(KEY_LAST_SEARCHED_URL, mSearchBoxEditText.getText().toString());
        ...
        outState.putString(KEY_LAST_RAW_JSON_RESULT, mSearchResultsTextView.getText().toString());
    }
}