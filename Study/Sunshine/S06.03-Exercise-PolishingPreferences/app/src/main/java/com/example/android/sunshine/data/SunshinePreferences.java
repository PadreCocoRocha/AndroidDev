...
public class SunshinePreferences {
    ...
    public static String getPreferredWeatherLocation(Context context) {
        ...
        return sharedPrefs.getString(context.getString(R.string.pref_location_key),
    ...
    public static boolean isMetric(Context context) {
        ...
        String currentUnit = sharedPrefs.getString(
                context.getString(R.string.pref_units_key), metricUnit);
        return currentUnit.equals(metricUnit);
    }
